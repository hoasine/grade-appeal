      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <Link href="/" className="flex items-center gap-3" aria-label="GradeAppeal home">
                <LogoMark size="md" className="flex md:hidden" />
                <Logo size="md" className="hidden md:flex" />
                <span className="ml-2 text-lg font-bold md:text-xl">GradeAppeal</span>
              </Link>

              <div className="hidden items-center gap-6 text-sm text-muted-foreground md:flex">
                Fair grade appeals on GenLayer Studionet
              </div>
